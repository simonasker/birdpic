...
class AppForm(QMainWindow):
    ...
    def create_main_frame(self):
        ...
        # Create the mpl Figure and FigCanvas objects.  5x4 inches, 100
        # dots-per-inch
        self.dpi = 100
        ...
        # add_subplot, but then the subplot configuration tool in the
        # navigation toolbar wouldn't work.
    ...
    # TODO Weird helper method, Maybe remove
    ...
    # TODO Another weird helper method. Study more carefully
